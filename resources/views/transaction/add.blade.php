...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="/admin/AM/plugins/fontawesome-free/css/all.min.css">
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="/admin/AM/plugins/ekko-lightbox/ekko-lightbox.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="/admin/AM/dist/css/adminlte.min.css">
</head>
...
<!-- jQuery -->
<script src="/admin/AM/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap -->
<script src="/admin/AM/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- Ekko Lightbox -->
<script src="/admin/AM/plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
<!-- AdminLTE App -->
<script src="/admin/AM/dist/js/adminlte.min.js"></script>
<!-- Filterizr-->
<script src="/admin/AM/plugins/filterizr/jquery.filterizr.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="/admin/AM/dist/js/demo.js"></script>
